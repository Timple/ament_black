...
#
# :param TESTNAME: the name of the test, default: "black"
...
function(ament_black)
  ...
  if(NOT ament_black_BIN)
    message(FATAL_ERROR "ament_black() variable 'ament_black_BIN' must not be empty")
  endif()
  ...
  ament_add_test(
    "${ARG_TESTNAME}"
    COMMAND ${cmd}
    OUTPUT_FILE "${CMAKE_BINARY_DIR}/ament_black/${ARG_TESTNAME}.txt"
